...
namespace Cryptography.Tests
{
    ...
    public class SDesTests
    {
        ...
        public SDesTests()
        {
            _largeTextExample = "asdasdasdasdasd" /*File.ReadAllText(Path.Combine(Directory.GetCurrentDirectory(), "Text examples", "Text example.txt"))*/;
        }
        ...
        {
            Assert.ThrowsException<ArgumentException>(() => SimplifiedDES.SimplifiedDES.Encrypt(_largeTextExample, "10100"));
        }

        [TestMethod]
        public void TestDecryptWrongKey()
        {
            Assert.ThrowsException<ArgumentException>(() => SimplifiedDES.SimplifiedDES.Decrypt(_largeTextExample, "10100"));
        }
    }
}
