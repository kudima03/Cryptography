...
public class RailFence
{
    ...
    public static string Encrypt(string text, int key)
    {
        ...
        for (var i = 0; i < lines.Length; i++) lines[i] = new StringBuilder(text.Length / key);
        ...
        for (var i = 0; i < text.Length; i++)
        {
            ...
            if (stringIndex == 0 || stringIndex == key - 1) directionDown = !directionDown;
        ...
        foreach (var line in lines) encryptedStr.Append(line);
    ...
    public static string Decrypt(string text, int key)
    {
        ...
        var linesLenght = Enumerable.Repeat(0, key).ToArray();
        ...
        for (var i = 0; i < text.Length; i++)
        {
            ...
            if (currentLine == 0 || currentLine == key - 1) directionDown = !directionDown;
        ...
        var lineLastSymbolIndex = Enumerable.Repeat(0, key).ToArray();
