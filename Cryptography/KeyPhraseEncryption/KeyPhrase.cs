...
public class KeyPhrase
{
    ...
    private static string Chipher(string text, string keyPhrase, bool encrypt)
    {
        ...
        foreach (var item in strings) result.Append(item);
    ...
    {
        return Chipher(text, keyPhrase, true);
    }
    ...
    public static string Decrypt(string text, string keyPhrase)
    {
        return Chipher(text, keyPhrase, false);
    }
